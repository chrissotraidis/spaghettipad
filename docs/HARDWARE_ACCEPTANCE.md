...
3. Phase 9: import MK64 Reloaded HD through Files, enable it by touch, and
   complete a Grand Prix at the Phase 6 baseline; attempt 4K only on an
   M-series iPad.
4. Phase 10: complete two-controller GP, VS, and battle sessions; record a
   frame-time capture and reconnect behavior, then attempt 3P/4P.
